...
public class StorageObject implements Serializable {
    ...
    public StorageObject(String storageProvider, String containerId, String objectId, String fileMd5, Long objectSize) {
        this.storageProvider=storageProvider;
        this.containerId=containerId;
        this.objectId=objectId;
        this.md5=fileMd5;
        this.objectSize = String.valueOf(objectSize);
    }
