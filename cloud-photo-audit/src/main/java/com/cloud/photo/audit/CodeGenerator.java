                ...
                .globalConfig(builder -> {
                    builder.author("egoist") // 设置作者
                           // .enableSwagger() // 开启 swagger 模式
                            ...
                            .outputDir("C:\\Users\\kiyana\\IdeaProjects\\cloud-photo\\cloud-photo-audit" + "/src/main/java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.cloud.photo") // 设置父包名
                          ...
                          //  .other("model.dto") // 设置dto包名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "C:\\Users\\kiyana\\IdeaProjects\\cloud-photo\\cloud-photo-audit"
