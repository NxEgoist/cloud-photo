...
public class VipsUtil {
    ...
    static String windowsCommand = "C:/Program Files/vips-dev-8.14/bin/vipsthumbnail.exe";
    ...
    public  static  void main(String[] args){
        String srcPath = "C:/Users/kiyana/Pictures/temp/111.jpg";
        String desPath = "C:/Users/kiyana/Pictures/temp/222.jpg";
        int tarWidth = 600;
        int tarHight = 600;
        String quality ="100";
